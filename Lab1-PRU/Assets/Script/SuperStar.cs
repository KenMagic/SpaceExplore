...
public class SuperStar : MonoBehaviour, ICollectable
{
    ...
    public void Collect()
    {
        ...
        AudioManager.Instance.PlaySoundEffect(AudioManager.Instance.rareStarSoundEffect); // Play star collect sound
